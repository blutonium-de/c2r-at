        ...
        {hasMany ? (
          <>
            <button
              ...
              className="absolute left-3 top-1/2 -translate-y-1/2 rounded-full bg-white/80 backdrop-blur border border-neutral-200 px-3 py-2 text-sm hover:bg-white transition"
            >
              ‹
            </button>
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full bg-white/80 backdrop-blur border border-neutral-200 px-3 py-2 text-sm hover:bg-white transition"
            >
              ›
            </button>

            <div className="absolute bottom-3 left-1/2 -translate-x-1/2 text-[11px] text-neutral-700 bg-white/75 border border-neutral-200 rounded-full px-3 py-1">
              {idx + 1} / {imgs.length}
            </div>
          </>
        ) : null}
